[![Travis build status shield](https://img.shields.io/travis/cozy/cozy-onlyoffice/master.svg)](https://travis-ci.org/cozy/cozy-onlyoffice)
[![Github Release version shield](https://img.shields.io/github/tag/cozy/cozy-onlyoffice.svg)](https://github.com/cozy/cozy-onlyoffice/releases)
...
Hacking the Cozy OnlyOffice app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/cozy/cozy-onlyoffice.git
$ cd cozy-onlyoffice
$ yarn install
```
...
After the build and the docker image launched, your app is now available at http://cozy-onlyoffice.cozy.tools:8080.
...
If you want to work on OnlyOffice and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for OnlyOffice is [cozy](https://github.com/cozy), send him/her a :beers: to say hello!
...
OnlyOffice is developed by cozy and distributed under the [AGPL v3 license][agpl-3.0].
