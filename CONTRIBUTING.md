# How to contribute to OnlyOffice?
...
- What is the version of the OnlyOffice app?
...
```
$ git clone github.com/cozy/cozy-onlyoffice.git
$ cd cozy-onlyoffice
$ git remote add fork git://github.com/yourusername/cozy-onlyoffice.git
```
...
Go to https://github.com/yourusername/cozy-onlyoffice and select your branch. Click the 'Pull Request' button and fill out the form.
...
The OnlyOffice is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-onlyoffice/issues/new
...
[localization]: https://github.com/cozy/cozy-onlyoffice/blob/master/README.md#localization
